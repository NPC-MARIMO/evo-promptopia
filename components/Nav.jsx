  ...
  return (
    <nav className='flex-between w-full mb-16 pt-3'>
      ...
      <Link href='/' className='flex gap-2 flex-center'>
        ...
        <p className="logo_text">Propmtopoia</p>
      ...
      {/* Mobile Navigation */}
      <div className="sm:hidden dlex relative">
        {isUserLoggedIn ? (
          <div className="flex">
                    <Image src='/assets/images/logo.svg' onClick={() => setToggleDropdown((prev) => !prev)} alt='profile' width={37} height={37} className=' rounded-full'
               />
